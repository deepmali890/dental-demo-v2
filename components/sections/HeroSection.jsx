      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:gap-16 lg:grid-cols-12 lg:items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-6 flex flex-col items-start">
            ...
            {/* Badge */}
            {data.badge && (
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50/50 px-4 py-1.5 mb-6 sm:mb-8">
            ...
            {/* Heading */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.1]">
            ...
            {/* Subheading */}
            {data.subheading && (
              <p className="mt-6 sm:mt-8 max-w-xl text-base sm:text-lg lg:text-xl leading-relaxed text-slate-600 font-medium">
                {data.subheading}
              </p>
            )}
            ...
            <div className="mt-10 sm:mt-12 flex flex-col sm:flex-row gap-4 sm:gap-5 w-full sm:w-auto">
              ...
              {data.primaryCta && (
                <div className="relative group w-full sm:w-auto">
                  ...
                  <CTAButton
                    ...
                    className="relative w-full sm:w-auto !bg-blue-600 !text-white !px-6 sm:!px-8 !py-3 sm:!py-4 !rounded-xl !font-bold flex items-center justify-center gap-2 hover:!bg-blue-700 transition"
                  />
                </div>
              )}
              ...
              {data.secondaryCta && (
                <CTAButton
                  ...
                  className="w-full sm:w-auto !bg-white !text-slate-900 !border-2 !border-slate-100 !px-6 sm:!px-8 !py-3 sm:!py-4 !rounded-xl !font-bold hover:!bg-slate-50 transition"
                />
              )}
            </div>
            ...
            {phone && (
              <a
                ...
                className="mt-6 sm:mt-8 flex items-center gap-3 group px-3 py-2 rounded-lg hover:bg-white/50 transition w-fit"
              >
